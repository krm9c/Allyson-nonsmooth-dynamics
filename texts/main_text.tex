...
\subsubsection{Experiment 2}
As an extension to Figure.~\ref{fig:mnist_comprehensive}, we conduct an experiment where we learn 10 tasks and plot the results in Figure.~\label{cnn}. We note now, that instead of the blanket improvement we observed in the sine dataset, we observe a significant improvement at the beginning for the first three tasks and then there is a significant jump that leads to significant deterioration. This jump introduces the sharp change what was shown in our theory to deteriorate performance. 
